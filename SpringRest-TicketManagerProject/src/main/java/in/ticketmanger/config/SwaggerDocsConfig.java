package in.ticketmanger.config;
...
public class SwaggerDocsConfig {
	...
	public Docket createDocket() {
		return new Docket(DocumentationType.SWAGGER_2).// UI Screen type
				...
				apis(RequestHandlerSelectors.basePackage("in.ticketmanger.restcontroller"))// base packages for//
																						// RestController
	...
	private ApiInfo getApiInfo() {
		Contact contact = new Contact("pratik", "http://www.google.com/course", "pratik@gmail.com");
